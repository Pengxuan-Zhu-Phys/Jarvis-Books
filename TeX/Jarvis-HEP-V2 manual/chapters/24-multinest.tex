...
\yamlkey{Bounds.seed}, construct the (always static, for \sampler{MultiNest})
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}p{0.255\linewidth}p{0.213\linewidth}p{0.532\linewidth}@{}}
    ...
    \yamlkey{seed} & \code{0} & \textsc{rng} seed; fix it for a reproducible proposal
      sequence. Like every sampler setting it goes in \yamlkey{Bounds}, not at the
      \yamlkey{Sampling} top level \\
