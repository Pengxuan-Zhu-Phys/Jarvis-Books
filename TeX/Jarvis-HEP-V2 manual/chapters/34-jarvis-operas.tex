...
\begin{terminal}
\begin{jcmd}
Jarvis2 operas list            # every registered name, by namespace
Jarvis2 operas info math.add   # signature and documentation
\end{jcmd}
\end{terminal}
...
\begin{description}[style=nextline, leftmargin=1.2em]
  ...
  \item[Package an entry point] --- expose the function from an installed package
        ...
        cluster, visible to \cli{Jarvis2 operas list} everywhere.
\end{description}
