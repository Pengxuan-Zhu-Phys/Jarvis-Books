...
\Jtwo\ delegates specialised jobs to sibling packages, and all three install
automatically as core dependencies --- nothing to opt into. Upgrading a sibling adds
features without a runtime release. Table~\ref{tab:ecosystem} names all three and
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}p{0.255\linewidth}p{0.213\linewidth}p{0.532\linewidth}@{}}
    ...
    \JPlot  & automatic   & \textsc{yaml}-driven figures from scan
