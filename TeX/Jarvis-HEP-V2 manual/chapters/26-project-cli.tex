...
\newthought{Projects are the unit of sharing.} \cli{Jarvis2 project} scaffolds new
...
\begin{terminal}
\begin{jcmd}
Jarvis2 project pack . --share    # curated: bin/ data/ outputs/ images/ + markers
Jarvis2 project pack . --repro    # default: all non-hidden top-level content
Jarvis2 project pack . --full     # everything
Jarvis2 project pack . --man      # write an editable pack manifest only
\end{jcmd}
\end{terminal}
...
\begin{terminal}
\begin{jcmd}
Jarvis2 project list          # table: Name, Access, Key, Category, Summary
Jarvis2 project info Eggbox   # details, incl. entry-point card and key hint
Jarvis2 project fetch Eggbox  # download + unpack a public project
\end{jcmd}
\end{terminal}
