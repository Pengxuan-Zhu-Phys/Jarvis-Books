...
\begin{terminal}
\begin{jcmd}
Jarvis run scan.yaml            # prompts when a checkpoint exists
Jarvis run scan.yaml --resume   # accepts it non-interactively
\end{jcmd}
\end{terminal}
...
\begin{jtip}
For long scans on shared machines, make \cli{Jarvis run scan.yaml --resume} the
