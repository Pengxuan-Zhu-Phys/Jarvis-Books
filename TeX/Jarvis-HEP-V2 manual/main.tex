...
\include{chapters/06-expressions}
\include{chapters/07-sampling-block}
\include{chapters/08-variables}
\include{chapters/09-loglikelihood}
\include{chapters/10-envreqs}

\part{Workflow Backends}\label{part:backends}
\include{chapters/11-command-system}
\include{chapters/12-workflow-model}
\include{chapters/13-calculators}
...
\include{chapters/22-toymcmc}
\include{chapters/23-ptmcmc}
\include{chapters/24-multinest}
\include{chapters/25-dynesty}
\include{chapters/26-check-modules}

\part{Running, Monitoring \& Outputs}\label{part:running}
\include{chapters/27-cli}
\include{chapters/28-project-cli}
\include{chapters/29-checkpoint}
\include{chapters/30-outputs}
\include{chapters/31-monitoring}
\include{chapters/32-logging}

\part{Advanced \& Performance}\label{part:advanced}
\include{chapters/33-distributed-runtime}
\include{chapters/34-performance}
\include{chapters/35-jarvisplot}
\include{chapters/36-jarvis-operas}
\include{chapters/37-reproducibility}
